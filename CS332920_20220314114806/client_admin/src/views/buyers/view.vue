		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','buyer_account') || $check_field('add','buyer_account') || $check_field('set','buyer_account')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="买家账号" prop="buyer_account">
					<el-input id="buyer_account" v-model="form_sub['buyer_account']" placeholder="请输入买家账号"
							  v-if="user_group === '管理员' || (form_sub['buyers_id'] && $check_field('set','buyer_account')) || (!form_sub['buyers_id'] && $check_field('add','buyer_account'))"></el-input>
					<div v-else-if="$check_field('get','buyer_account')">{{form_sub['buyer_account']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','full_name') || $check_field('add','full_name') || $check_field('set','full_name')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="姓名" prop="full_name">
					<el-input id="full_name" v-model="form_sub['full_name']" placeholder="请输入姓名"
							  v-if="user_group === '管理员' || (form_sub['buyers_id'] && $check_field('set','full_name')) || (!form_sub['buyers_id'] && $check_field('add','full_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','gender') || $check_field('add','gender') || $check_field('set','gender')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="性别" prop="gender">
					<el-select id="gender" v-model="form_sub['gender']"
						v-if="user_group === '管理员' || (form_sub['buyers_id'] && $check_field('set','gender')) || (!form_sub['buyers_id'] && $check_field('add','gender'))">
