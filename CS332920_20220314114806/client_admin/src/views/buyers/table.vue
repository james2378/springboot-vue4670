			...
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8">
					<el-form-item label="买家账号">
						<el-input v-model="query.buyer_account"></el-input>
					</el-form-item>
				</el-col>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/buyers/table','add') || $check_action('/buyers/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/buyers/table','del') || $check_action('/buyers/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
