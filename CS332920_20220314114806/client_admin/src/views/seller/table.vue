		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						<router-link v-if="user_group == '管理员' || $check_action('/seller/table','add') || $check_action('/seller/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/seller/table','del') || $check_action('/seller/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
