		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','seller') || $check_field('add','seller') || $check_field('set','seller')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="卖家" prop="seller">
					<el-input id="seller" v-model="form_sub['seller']" placeholder="请输入卖家"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','seller')) || (!form_sub['seller_id'] && $check_field('add','seller'))"></el-input>
					<div v-else-if="$check_field('get','seller')">{{form_sub['seller']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','full_name') || $check_field('add','full_name') || $check_field('set','full_name')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="姓名" prop="full_name">
					<el-input id="full_name" v-model="form_sub['full_name']" placeholder="请输入姓名"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','full_name')) || (!form_sub['seller_id'] && $check_field('add','full_name'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','gender') || $check_field('add','gender') || $check_field('set','gender')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="性别" prop="gender">
					<el-select id="gender" v-model="form_sub['gender']"
						v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','gender')) || (!form_sub['seller_id'] && $check_field('add','gender'))">
