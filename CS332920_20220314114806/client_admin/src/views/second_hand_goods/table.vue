<template>
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="24" :lg="8">
					<el-form-item label="新旧程度">
						<el-input v-model="query.new_and_old_degree"></el-input>
					</el-form-item>
				</el-col>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/second_hand_goods/table','add') || $check_action('/second_hand_goods/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/second_hand_goods/table','del') || $check_action('/second_hand_goods/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="commodity_specifications" label="商品规格"
				v-if="user_group == '管理员' || $check_field('get','commodity_specifications')" min-width="200">
			</el-table-column>
			<el-table-column prop="new_and_old_degree" label="新旧程度"
				v-if="user_group == '管理员' || $check_field('get','new_and_old_degree')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/second_hand_goods/table','set') || $check_action('/second_hand_goods/view','set') || $check_action('/second_hand_goods/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/second_hand_goods/table','set') || $check_action('/second_hand_goods/view','set') || $check_action('/second_hand_goods/view','get')"
