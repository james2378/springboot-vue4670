<template>
	<div class="diy_details page_second_hand_goods" id="second_hand_goods_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_second_hand_goods'>
							<div_second_hand_goods :obj="obj"></div_second_hand_goods>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_second_hand_goods from "@/components/diy/div_second_hand_goods.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_second_hand_goods
		},
		data(){
			return{
